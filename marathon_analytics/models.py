...
def load_data():
    ...
    filename = '/Users/lancesinson/Desktop/2023_chicago_results.csv'
    ...
    for line in f:
        ...
        try:
            ...
            # ['6', 'Seifu', 'Tura Abdiwak', 'ETH', 'Addis Abeba', 'Addis Abeba', 'Male', '25-29', '5', '5', '2', '7:30:02', '9:35:31', '2:05:29', '1:02:21', '1:03:08']
            # fields[0] = 6
            # fields[1] = Seifu
